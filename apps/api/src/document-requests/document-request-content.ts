...
export const DEFAULT_KURDISH_BODY_TEMPLATE_FIELDS: BodyTemplateFields = {
  introText:
    'داواکارین لە بەڕیزتان ڕەزامەندی بفەرموون بۆ ناردنی بروانەمە و پڕۆفایلی فێرخواز',
  ...
  closingText:
    'لە ڕێگەی کۆدی ئی پەروەردەوە بۆ کۆدی پەیمانگا (٦٠٢٠١٠) یان بەدەستی فێرخواز بۆمان ڕەوان بکەن.',
};
